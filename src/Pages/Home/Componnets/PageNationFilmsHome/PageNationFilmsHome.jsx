...
export default function PageNationFilmsHome({}) {
  ...
  function TwelveTopImdbfunc() {
    const TwelveTopImdbPromise = Promise.resolve(TwelveTopImdb(cunterpage));
